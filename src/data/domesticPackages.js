...
const domestic = [
  {
    ...
    highlights: ["Dal Lake Houseboat", "Gulmarg Gondola", "Pahalgam Valley", "Tulip Garden"],
    images: [
  ...
  },
  {
    ...
    highlights: ["Baga & Calangute Beach", "Dudhsagar Falls", "Old Goa Churches", "Cruise Party"],
    images: [
  ...
  },
  {
    ...
    highlights: ["Jaipur Pink City", "Jaisalmer Fort", "Udaipur Lake Palace", "Ranthambore Tiger Reserve"],
    images: [
  ...
  },
  {
    ...
    highlights: ["Rohtang Pass", "Solang Valley", "Mall Road Shimla", "Hadimba Temple"],
    images: [
  ...
  },
  {
    ...
    highlights: ["Radhanagar Beach", "Scuba Diving", "Cellular Jail", "Havelock Island"],
    images: [
  ...
  },
  {
    ...
    highlights: ["River Rafting", "Laxman Jhula", "Kedarnath Temple", "Nainital Lake"],
    images: [
  ...
  },
  {
    ...
    highlights: ["Meenakshi Amman Temple", "Marina Beach", "Ooty Nilgiris", "Thanjavur Big Temple"],
    images: [
